...
public class MainConfigScreen extends Screen {
    ...
    public MainConfigScreen(Screen lastScreen) {
        super(Component.translatable("brainlink.configscreen.title")); // Screen title
    ...
    protected void init() {
        ...
        }).setTooltip(Tooltip.create(Component.translatable("brainlink.updatedelay.tooltip")));
        ...
        }).setTooltip(Tooltip.create(Component.translatable("brainlink.datatimeused.tooltip")));
