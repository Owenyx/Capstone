...
public class DeviceScreen extends Screen {
    ...
    protected void init() {
        ...
        switch (Config.getChosenDevice()) {
            case "eeg":
                chosenDevice = I18n.get("brainlink.devicenames.eeg"); // The I18n class is used for translations
                break;
            case "heg":
                chosenDevice = I18n.get("brainlink.devicenames.heg");
                break;
            default:
                chosenDevice = "None";
        }
        ...
        if (Config.getChosenDevice().equals("eeg")) {
            ...
            this.addRenderableWidget(Button.builder(
                ...
                .pos(this.width / 2 - 100, currentY += gap)
                .width(buttonWidth)
                .build()).setTooltip(Tooltip.create(Component.translatable("brainlink.setdatasource.tooltip")));
