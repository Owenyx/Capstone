...
public class PathRootScreen extends Screen {
    ...
    public PathRootScreen(Screen lastScreen) {
        super(Component.translatable("brainlink.pathrootscreen.title")); 
    ...
    protected void init() {
        ...
        this.addRenderableWidget(Button.builder(
            ...
            .width(buttonWidth)
            .build()
            ).setTooltip(Tooltip.create(Component.translatable("brainlink.signal.tooltip")));
        ...
        this.addRenderableWidget(Button.builder(
            ...
            .width(buttonWidth)
            .build()
            ).setTooltip(Tooltip.create(Component.translatable("brainlink.waves.tooltip")));
