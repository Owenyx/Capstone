...
import com.owen.brainlink.events.ConfigEvents.EEGPathChangedEvent;
import com.owen.brainlink.network.UpdateAttributeMessage;
...
public class DataManager {
    ...
    private DataManager() {
        ...
        network = ChannelBuilder.named(ResourceLocation.fromNamespaceAndPath(BrainLink.MOD_ID, BrainLink.MOD_ID)).networkProtocolVersion(1).optionalClient().clientAcceptedVersions(Channel.VersionTest.exact(1)).simpleChannel();
